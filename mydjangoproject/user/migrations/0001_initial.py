    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(verbose_name='更新时间', auto_now=True)),
                ('is_delete', models.BooleanField(verbose_name='删除标记', default=False)),
                ('receivers', models.CharField(verbose_name='收件人', max_length=20)),
                ('address', models.CharField(verbose_name='收获地址', max_length=256)),
                ('postcode', models.CharField(verbose_name='邮政编码', max_length=6, null=True)),
                ('phone', models.CharField(verbose_name='联系电话', max_length=11)),
                ('is_default', models.BooleanField(verbose_name='是否为默认', default=False)),
